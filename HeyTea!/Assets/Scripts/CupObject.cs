...
public class CupObject : HeyTeaObject,IKichenwareObejct {
    ...
    [SerializeField] private Dictionary<IKichenwareObejct.MilkTeaMaterialType, MilkTeaMaterialQuota> milkTeaMaterialQuotasDic = new Dictionary<IKichenwareObejct.MilkTeaMaterialType, MilkTeaMaterialQuota>();
    ...
    private void SetCurrentMilkTeaMatrialQuotasDicAllZero() {
        foreach(KeyValuePair<IKichenwareObejct.MilkTeaMaterialType, MilkTeaMaterialQuota> entry in milkTeaMaterialQuotasDic) {
    ...
    public Dictionary<IKichenwareObejct.MilkTeaMaterialType, MilkTeaMaterialQuota> GetMilkTeaMaterialDic() {
